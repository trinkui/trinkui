...
const exampleCode = `import { FeaturesGrid } from "@trinkui/react";
...
export default function Example() {
  return (
    <FeaturesGrid
      ...
      subtitle="Production-ready components for your next project."
      features={[
        { icon: "⚡", title: "Fast", description: "Optimized for performance." },
        { icon: "🎨", title: "Themeable", description: "Customize with CSS variables." },
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <h1 className="text-3xl font-bold text-[rgb(var(--trinkui-fg))]">FeaturesGrid</h1>
