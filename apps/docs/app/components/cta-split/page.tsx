import { CTASplit } from "@trinkui/react";
import { ComponentPreview } from "@/components/ComponentPreview";
import { PropsTable } from "@/components/PropsTable";

const exampleCode = `import { CTASplit } from "@trinkui/react";
...
export default function CTASplitPage() {
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <p className="mb-1 text-sm font-medium text-[rgb(var(--trinkui-primary))]">CTA</p>
        <h1 className="text-3xl font-bold text-[rgb(var(--trinkui-fg))]">CTASplit</h1>
        <p className="mt-2 text-[rgb(var(--trinkui-muted))]">
          Two-column split CTA with text on the left and action buttons on the right.
        </p>
      </div>
