import { FAQGrid } from "@trinkui/react";
import { ComponentPreview } from "@/components/ComponentPreview";
import { PropsTable } from "@/components/PropsTable";

const exampleCode = `import { FAQGrid } from "@trinkui/react";
...
export default function FAQGridPage() {
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <p className="mb-1 text-sm font-medium text-[rgb(var(--trinkui-primary))]">FAQ</p>
        <h1 className="text-3xl font-bold text-[rgb(var(--trinkui-fg))]">FAQGrid</h1>
        <p className="mt-2 text-[rgb(var(--trinkui-muted))]">
          Two-column grid layout for FAQ items — best for 4–8 questions shown all at once.
        </p>
      </div>
