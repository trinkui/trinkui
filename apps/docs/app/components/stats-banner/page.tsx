import { StatsBanner } from "@trinkui/react";
import { ComponentPreview } from "@/components/ComponentPreview";
import { PropsTable } from "@/components/PropsTable";

const exampleCode = `import { StatsBanner } from "@trinkui/react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <h1 className="text-3xl font-bold text-[rgb(var(--trinkui-fg))]">StatsBanner</h1>
        <p className="mt-2 text-[rgb(var(--trinkui-muted))]">
          Full-width banner displaying key stats in a horizontal row with subtle background.
        </p>
      </div>
