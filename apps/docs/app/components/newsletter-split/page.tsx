import { NewsletterSplit } from "@trinkui/react";
import { ComponentPreview } from "@/components/ComponentPreview";
import { PropsTable } from "@/components/PropsTable";

const exampleCode = `import { NewsletterSplit } from "@trinkui/react";
...
export default function NewsletterSplitPage() {
  return (
    <div className="space-y-8">
      <div>
        <p className="mb-1 text-sm font-medium text-[rgb(var(--trinkui-primary))]">Other Sections</p>
        <h1 className="text-3xl font-bold text-[rgb(var(--trinkui-fg))]">NewsletterSplit</h1>
        <p className="mt-2 text-[rgb(var(--trinkui-muted))]">Two-column split newsletter section with text on the left and email form on the right.</p>
      </div>
      <div>
