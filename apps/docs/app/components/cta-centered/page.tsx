import { CTACentered } from "@trinkui/react";
import { ComponentPreview } from "@/components/ComponentPreview";
import { PropsTable } from "@/components/PropsTable";

const exampleCode = `import { CTACentered } from "@trinkui/react";
...
export default function CTACenteredPage() {
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <p className="mb-1 text-sm font-medium text-[rgb(var(--trinkui-primary))]">CTA</p>
        <h1 className="text-3xl font-bold text-[rgb(var(--trinkui-fg))]">CTACentered</h1>
        <p className="mt-2 text-[rgb(var(--trinkui-muted))]">
          Centered call-to-action section with pill badge, headline, subtitle, and action buttons.
        </p>
      </div>
